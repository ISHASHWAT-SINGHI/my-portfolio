      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a 
                ...
                className="flex items-center gap-2 text-slate-300 hover:text-white transition duration-300"
              >
                <span>💼</span> LinkedIn
              </a>
              <a 
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#projects" className="block text-slate-300 hover:text-white transition duration-300">Projects</a>
              <a href="#about" className="block text-slate-300 hover:text-white transition duration-300">About Me</a>
              <a href="#contact" className="block text-slate-300 hover:text-white transition duration-300">Contact</a>
            </div>
          </div>
        </div>
